#!/usr/bin/env python3
"""
G-Studio Enterprise Code Intelligence Platform v7.2.1
======================================================
...
CHANGES IN v7.2.1:
-------------------
• Fixed cache serialisation – all Enums, Path, datetime now handled automatically.
• WiringIssueDetector fully implemented (no missing __init__).
...
• Delete old .gstudio_cache.json after upgrading to avoid enum conversion issues.
...
class CacheManager:
    ...
    def __init__(self, cache_path: Path, use_cache: bool = True, version: str = "7.2.1"):
...
class GStudioAnalyzer:
    ...
    def __init__(self,
        ...
        # Cache
        self.cache = CacheManager(project_path / Config.CACHE_FILE, use_cache and not dry_run, version="7.2.1")
    ...
    def analyze(self) -> AnalysisResult:
        log_header("G-STUDIO ENTERPRISE CODE INTELLIGENCE v7.2.1")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="G-Studio Enterprise Code Intelligence v7.2.1",

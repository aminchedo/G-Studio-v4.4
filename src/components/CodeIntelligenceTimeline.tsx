...
export const CodeIntelligenceTimeline: React.FC<
  CodeIntelligenceTimelineProps
> = ({
  ...
  useEffect(() => {
    ...
    ["breaking", "risky", "safe"].forEach((key, i) => {
  ...
  const handlePlay = () => {
    ...
    const endTime =
      breakingChangeReports[breakingChangeReports.length - 1].timestamp;
  ...
  const handleSkip = (direction: "forward" | "backward") => {
    ...
    const index = breakingChangeReports.findIndex(
      (r) => r.timestamp >= current,
    );

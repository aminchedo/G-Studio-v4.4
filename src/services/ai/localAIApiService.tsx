...
export class LocalAIApiService {
  ...
  static async processRequest(
    ...
    try {
      ...
      await LocalAILogger.logError(`Request failed: ${error.message}`, error, {
        requestId,
      });
  ...
  static async downloadModel(
    ...
    try {
      ...
      await LocalAIModelService.downloadModel(async (progress) => {
  ...
  static async getLogs(filter?: {
    ...
    await this.ensureInitialized();
    return await LocalAILogger.getLogs(filter as any);
  }

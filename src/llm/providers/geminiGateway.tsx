...
// Gateway uses service-layer client factory so only services import @google/genai
import { createGenAIClient } from "@/services/geminiService/createGenAIClient";
import type {
  GenerateContentResponse,
  UsageMetadata,
  Part,
} from "@/services/geminiService/types";
...
export async function callGeminiGateway(
  ...
  console.warn(
    "[GeminiGateway] WARNING: Direct gateway call bypasses API Model Test enforcement. Use GeminiService.streamChat() for production requests.",
  );
...
export async function* streamGeminiGateway(
  ...
  // ⚠️ WARNING: This call bypasses API Model Test enforcement
  console.warn(
    "[GeminiGateway] WARNING: Direct gateway streaming call bypasses API Model Test enforcement. Use GeminiService.streamChat() for production requests.",
  );

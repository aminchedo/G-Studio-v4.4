...
import { Mic, Code, Layout } from "lucide-react";

type ViewMode = "code" | "voice" | "split";

interface IntegratedConversationalIDEProps {
  /** API key from app (Settings / AI Settings Hub) so Vcode works without re-entering */
  initialApiKey?: string;
}

export const IntegratedConversationalIDE: React.FC<
  IntegratedConversationalIDEProps
> = ({ initialApiKey }) => {
    ...
    <div className="integrated-conversational-ide h-full flex flex-col bg-gray-950">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {(viewMode === "code" || viewMode === "split") && (
          <div
            className={`${viewMode === "split" ? "w-2/3" : "w-full"} border-r border-gray-800`}
          >
        ...
        {(viewMode === "voice" || viewMode === "split") && (
          <div
            className={`${viewMode === "split" ? "w-1/3" : "w-full"} p-4 overflow-y-auto`}
          >
            <VoiceConversationUI

...
import { McpToolResult, McpToolCallbacks, ToolCategory } from "@/types";
...
> = {
  // File Operations
  create_file: { category: "file", handler: FileOps.createFile },
  read_file: { category: "file", handler: FileOps.readFile },
  write_code: { category: "file", handler: FileOps.writeCode },
  edit_file: { category: "file", handler: FileOps.editFile },
  move_file: { category: "file", handler: FileOps.moveFile },
  delete_file: { category: "file", handler: FileOps.deleteFile },
  search_files: { category: "file", handler: FileOps.searchFiles },
  open_file: { category: "file", handler: FileOps.openFile },
  get_file_info: { category: "file", handler: FileOps.getFileInfo },
};

/**
 * Settings Icons - High-Quality SVG Icons
 * Minimalist, modern icon set for settings module
 */
...
export const GeneralIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M12 2.5a9.5 9.5 0 1 1 0 19 9.5 9.5 0 0 1 0-19" />
  </svg>
);
...
export const PrivacyIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const AdvancedIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <circle cx="12" cy="12" r="3" />
    <path d="M12 1v6m0 6v6m7.07-11.07l-4.24 4.24m0 5.66l4.24 4.24M23 12h-6m-6 0H5m4.93 7.07l4.24-4.24m0-5.66l-4.24-4.24" />
  </svg>
);

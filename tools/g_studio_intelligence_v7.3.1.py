#!/usr/bin/env python3
"""
G-Studio Enterprise Code Intelligence Platform v7.2.2
======================================================
...
CHANGES IN v7.2.2:
-------------------
• Fixed 'FileInfo' object has no attribute 'value_score' error.
  Added value_score field to FileInfo, populated during valuable scoring.
• Cache serialisation now handles all Enums, Path, datetime automatically.
• Reports always written to the specified output directory (default ./gstudio-reports).
• Full backward compatibility – run without flags = original v7.
...
# =============================================================================
# CACHE MANAGER (v7 enhanced + JSON encoder for Enums/Path/datetime)
# =============================================================================
class CacheManager:
    """File-based cache with version awareness and robust serialisation."""

    class _JSONEncoder(json.JSONEncoder):
        """Handles Enums, Path, datetime and other non-serializable types."""
        def default(self, obj):
            ...
            # Let the base class raise TypeError for others
            return super().default(obj)

    def __init__(self, cache_path: Path, use_cache: bool = True, version: str = "7.2.2"):
...
class GStudioAnalyzer:
    ...
    def __init__(self,
        ...
        # Cache
        self.cache = CacheManager(project_path / Config.CACHE_FILE, use_cache and not dry_run, version="7.2.2")
    ...
    def analyze(self) -> AnalysisResult:
        log_header("G-STUDIO ENTERPRISE CODE INTELLIGENCE v7.2.2")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="G-Studio Enterprise Code Intelligence v7.2.2",

#!/usr/bin/env python3
"""
G-Studio Intelligent Code Analyzer v6.2.1-beta
===============================================
Main Purpose:
...
What's new in v6.2.1-beta:
    ✓ **Robust tree‑sitter API compatibility** – now uses try/except instead of
      `hasattr` to support all versions (0.19, 0.20, 0.21+). Never crashes on init.
    ✓ Fixed regression in v6.2.0 that caused `set_language` errors on older tree‑sitter.
    ✓ Full backwards compatibility – all v6.2.0 features remain intact.
...
class Config:
    ...
    # Context names allowed to be directly used with useContext
...
class ArchitecturalInsight:
    ...
    # For circular dependencies, list of affected files
...
# =============================================================================
# FILE PARSER – FIXED for all tree‑sitter versions (v6.2.1)
# =============================================================================
class FileParser:
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Generated by G-Studio Code Intelligence v6.2.1-beta<br>
...
class GStudioAnalyzer:
    ...
    def analyze(self) -> AnalysisResult:
        log_header("G-STUDIO INTELLIGENT CODE ANALYZER v6.2.1-beta")
...
def main():
    parser = argparse.ArgumentParser(
        description="G-Studio Intelligent Code Analyzer v6.2.1-beta",
